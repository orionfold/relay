...
_Last updated: 2026-07-08 (pt: **Default card toolbar wash aligned.** `CardStatusToolbar` now uses the Projects reference wash for default/ready card footers, and the patch is being released as 0.36.1.)_
